...
//30182NY_Achour locator01
    ...
    public static final String StorageCss="#sprint_storage_selector > label:nth-child(3) > span > div > div";
    ...
    public static final String featureCss="#main > div.device-page.device-page--detail.device-page--zoom-in.device-page--thumbnails.device-page--with-sticky > div > div.row > div.col-xs-12.col-md-6.mb-20.mb-md-0 > div.align-center.font-medium.device-features.my-10.pl-10 > button";
